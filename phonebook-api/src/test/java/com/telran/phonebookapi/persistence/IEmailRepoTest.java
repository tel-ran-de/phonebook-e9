...
class IEmailRepoTest {
    ...
    public void testGetByContact_threeContacts_twoFound(){
        ...
        List<Email> emailsFromBD = emailRepo.getByContact(contact);
        assertEquals(2, emailsFromBD.size());
        assertEquals("email@email", emailsFromBD.get(0).getEmail());
        assertEquals("email2@email", emailsFromBD.get(1).getEmail());
    }
    ...
    public void testGetByContact_threeContacts_noFound(){
        ...
        List<Email> emailsFromBD = emailRepo.getByContact(contact2);
    ...
    public void testFindByContactId_threeContacts_twoFound(){
        ...
        List<Email> emailsFromBD = emailRepo.findByContactId(1);
        assertEquals(2, emailsFromBD.size());
        assertEquals("email@email", emailsFromBD.get(0).getEmail());
    ...
    public void testFindByContactId_threeContacts_noFound(){
        ...
        List<Email> emailsFromBD = emailRepo.findByContactId(2);
        assertEquals(0, emailsFromBD.size());
    }
